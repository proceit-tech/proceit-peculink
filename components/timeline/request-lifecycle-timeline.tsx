...
export default function RequestLifecycleTimeline({
  ...
  return (
    <section className="rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03)_0%,rgba(255,255,255,0.015)_100%)] p-6">
      <div className="mb-6">
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 xl:grid-cols-[80px_1fr]">
          <div className="flex flex-col items-center pt-2">
            <StepDot tone="cyan" />
            <span className="mt-3 h-full min-h-[120px] w-px bg-white/10" />
          </div>
          ...
          <div className="rounded-[24px] border border-white/10 bg-white/[0.03] p-6">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-white/58">
                  Las ofertas muestran quién respondió, en qué condición y con qué valor
                  económico.
                </p>
              </div>
          ...
          <div className="rounded-[24px] border border-white/10 bg-white/[0.03] p-6">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-white/58">
                  Esta etapa muestra si la operación ya tiene cobertura logística, capacidad
                  asignada y ruta de ejecución.
                </p>
              </div>
